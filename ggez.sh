...
if test -s /etc/nginx/nginx.conf; then
  ...
  wget -P /etc/nginx https://raw.githubusercontent.com/V2RaySSR/Trojan_panel_web/master/nginx.conf
	green "========================================================"
	blue "      Please enter the domain name bound by Trojan "
	green "========================================================"
	read your_domain
  sed -i "s/localhost/$your_domain/;" /etc/nginx/nginx.conf
	green " "
	green "================================================================================="
	 blue "     Start downloading and deploying the source code of the disguised site "
	green "================================================================================="
	sleep 2s
	...
	green " "
	green "==========================================="
	blue "        Start configuring trojan-web "
	green "==========================================="
	sleep 2s
  ...
  green " "
	...
	green " "
	 blue "   Script exchange telegram group: https://goii.cc/tg "
	green " "
...
be
	...
	green "========================================="
	  red "The Trojan Panel Service is not detected "
	green "========================================="
	sleep 2s
	exit 1
be
...
start_menu(){
  clear
   ...
   blue " This script supports: Debian9+ / Ubuntu16.04+ / Centos7+ "
	 blue " Website: www.v2rayssr.com (Domestic access is prohibited) "
	 blue " YouTube Channel: Pozai Sharing "
   ...
   blue " Introduction: One-click to change the Trojan-Panel panel port and set up a fake site "
	...
	green "=========================================================="
	 blue " 1. Trojan multi-user management deployment program of Jrohy Great God "
   blue " 2. Change the Trojan panel port and set up a fake site "
   blue " 3. Install BBRPlus4 in one acceleration "
